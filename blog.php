...
<div class="row">
  ...
  <div class="row">
                            ...
                            <div class="info">Posted on: Jul 1, 2018</div>                                               
...
<!-- blog list -->
  <div class="row">
                            ...
                            <div class="col-lg-8 col-sm-8 ">
                            <h3><a href="blogdetail.php">New way for business</a></h3>
                            <div class="info">Posted on: Jul 2, 2018</div>                                               
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                            <a href="blogdetail.php" class="more">Read More</a>
                            </div>
  </div>
  ...
  <div class="row">
                            ...
                            <div class="col-lg-8 col-sm-8 ">
                            <h3><a href="blogdetail.php">Futur asset</a></h3>
                            <div class="info">Posted on: Jul 3, 2018</div>                                               
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                            <a href="blogdetail.php" class="more">Read More</a>
                            </div>
  </div>
  ...
  <div class="row">
                            <div class="col-lg-4 col-sm-4 "><a href="blogdetail.php" class="thumbnail"><img src="images/blog/4.jpg" alt="blog title"></a></div>
                            <div class="col-lg-8 col-sm-8 ">
                            <h3><a href="blogdetail.php">Inovant House</a></h3>
                            <div class="info">Posted on: Jul 4, 2018</div>                                               
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                            <a href="blogdetail.php" class="more">Read More</a>
                            </div>
  </div>
  ...
  <div class="row">
                            ...
                            <div class="col-lg-8 col-sm-8 ">
                            <h3><a href="blogdetail.php">Classic English House</a></h3>
                            <div class="info">Posted on: Jul 5, 2018</div>                                               
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                            <a href="blogdetail.php" class="more">Read More</a>
                            </div>
  </div>
